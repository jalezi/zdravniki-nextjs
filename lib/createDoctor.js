...
export default function createDoctor(doctorObject, institution) {
  ...
  const doctor = Object.freeze({
    ...
    get fullAddress() {
      const street = addressObject.street ? `${addressObject.street},` : '';
      return `${street} ${addressObject.postalCode} ${addressObject.post}`;
    },
    ...
    get instId() {
      return trimString(doctorObject.id_inst) || 'neznan';
    },
